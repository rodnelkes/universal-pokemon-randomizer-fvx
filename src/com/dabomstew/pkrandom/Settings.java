...
public class Settings {
    ...
    public static Settings fromString(String settingsString) throws UnsupportedEncodingException, IllegalArgumentException {
        ...
        settings.setRandomizeEVYields(restoreState(data[65], 1));
        settings.setRandomizeCatchRate(restoreState(data[65], 2));
        settings.setRandomizeBaseExpYield(restoreState(data[65], 3));
        settings.setRandomizeHeight(restoreState(data[65], 4));
        settings.setRandomizeWeight(restoreState(data[65], 5));
    ...
    public boolean isRandomizeCatchRate() {
        return randomizeCatchRate;
    }

    public void setRandomizeCatchRate(boolean randomizeCatchRate) {
