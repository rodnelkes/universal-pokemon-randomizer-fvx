...
public class Gen7Constants {
    ...
    public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2, bsSpeedOffset = 3,
            ...
            bsFormeSpriteOffset = 30, bsFormeCountOffset = 32, bsBaseExpYieldOffset = 34, bsHeightOffset = 36,
            bsWeightOffset = 38, bsTMHMCompatOffset = 40, bsSpecialMTCompatOffset = 56, bsMTCompatOffset = 60;
