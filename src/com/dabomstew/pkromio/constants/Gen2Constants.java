...
public class Gen2Constants {
    ...
    public static final int bsHPOffset = 1, bsAttackOffset = 2, bsDefenseOffset = 3, bsSpeedOffset = 4,
            ...
            bsCatchRateOffset = 9, bsBaseExpYield = 10, bsCommonHeldItemOffset = 11, bsRareHeldItemOffset = 12,
            bsFrontImageDimensionsOffset = 17, bsGrowthCurveOffset = 22, bsTMHMCompatOffset = 24, bsMTCompatOffset = 31;
