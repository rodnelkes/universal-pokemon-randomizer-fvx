...
public class Gen4Constants {
    ...
    public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2, bsSpeedOffset = 3,
            ...
            bsCatchRateOffset = 8, bsBaseExpYieldOffset = 9, bsEVYieldOffset = 10, bsCommonHeldItemOffset = 12,
            bsRareHeldItemOffset = 14, bsGenderRatioOffset = 16, bsGrowthCurveOffset = 19, bsAbility1Offset = 22,
